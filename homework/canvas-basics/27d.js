(function () {
    ...
    for (var i = 0; i < 2; i++) {
        ...
        renderingContext.bezierCurveTo(change+(height/5.5), y, change+(height/5.5), y+height, change, y+height);
        renderingContext.bezierCurveTo(change-(height/5.5), y+height, change-(height/5.5), y, change, y);
    }
    renderingContext.closePath();
    renderingContext.fill();
